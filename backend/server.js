...
app.use(express.json({ limit: '10mb' })); // Optional: Increased from default 100kb
...
app.use('/api/users', upload.single('image'), userRoutes); // Apply multer to user routes
app.use('/api/chatrooms', chatRoomRoutes); // No file upload needed here
